...
const CATEGORY_INTRO: Record<string, string> = {
  ...
  "sleeping-bag":
    "シュラフ選びで最も大事なのは「使用可能温度域」です。寒すぎるシュラフで眠れなかった経験は、キャンプをやっていれば誰でも一度はあるはず。僕も初年度に10℃対応のシュラフで5月の長野に行き、夜中に目が覚めて震えながら朝を待った苦い思い出があります。封筒型とマミー型の違い、化繊とダウンの使い分け、快適温度の見方まで、初心者でも分かるように解説しています。季節と予算に合った最適な一枚を見つけてください。",
  burner:
  ...
  "insect-repellent":
    "虫対策はキャンプの快適さを大きく左右します。特に夏の夜、対策が不十分だとブヨやヤブ蚊の猛攻で眠れないほど辛い思いをします。僕も長野のキャンプ場でブヨに顔を何か所も刺され、翌日腫れて帰った苦い経験があります。それ以来、虫除けスプレー・線香・ランタン型忌避剤を組み合わせて使うようになりました。スプレーの成分（DEET・イカリジン）の違い、子供への安全な使い方、ブヨ・蚊・アブそれぞれの対策まで、実体験をもとに詳しく解説しています。",
  tumbler:
