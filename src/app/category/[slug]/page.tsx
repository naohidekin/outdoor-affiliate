...
const CATEGORY_INTRO: Record<string, string> = {
  ...
  "sleeping-bag":
    "シュラフ選びで最も大事なのは「使用可能温度域」です。寒すぎるシュラフで眠れなかった経験は、キャンプをやっていれば誰でも一度はあるはず。僕も初年度に10℃対応のシュラフで5月の東京近郊の山間キャンプ場に行き、夜中に目が覚めて震えながら朝を待った苦い思い出があります。封筒型とマミー型の違い、化繊とダウンの使い分け、快適温度の見方まで、初心者でも分かるように解説しています。あわせて、地面からの冷えを断つマットとコットも扱っています。実は寒さ対策は、シュラフのグレードを上げるより先に下からの断熱を見直すほうが効くことが多いです。",
  burner:
