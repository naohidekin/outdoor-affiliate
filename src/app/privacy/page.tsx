      ...
      <main className="flex-1">
        <article className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="prose max-w-none">
            ...
            <h2>アクセス計測の除外設定</h2>
            <p>
              管理・動作確認用のブラウザーには、計測の除外設定をCookieに最長1年間保存します。
              設定中はPostHog・Googleアナリティクス・当サイトの購入先クリック集計への送信を停止します。
              このCookieは認証には使用しません。管理画面へのログイン・アクセス時にも設定され、ログアウト後も継続します。
              <Link href="/analytics-settings">アクセス計測の設定</Link>から確認・変更できます。
            </p>
            <h2>PostHogによる利用状況の解析について</h2>
            <p>
              記事や比較表の使いやすさを改善するため、PostHogを利用します。
              閲覧したページ、比較表への到達、商品リンクの表示・クリック、端末情報を
              PostHogへ送信します。識別子はブラウザーのセッションストレージに保存します。
              販売店での購入完了や注文内容を取得するものではありません。
            </p>
            <p>
              記事ページでは操作を再生するセッションリプレイを利用する場合があります。
              入力欄と画面上の文字をマスクし、管理画面やお問い合わせページは対象外とします。
              URLの検索パラメーターや商品リンク先URLは解析イベントに送信しません。
              詳しくは<a href="https://posthog.com/privacy" target="_blank" rel="noopener noreferrer">PostHogのプライバシーポリシー</a>をご確認ください。
            </p>
