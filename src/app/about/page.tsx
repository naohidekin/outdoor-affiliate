        ...
        <article className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="prose max-w-none">
            ...
            <ul>
              ...
              <li>
                <strong>趣味</strong>：キャンプ、AI個人開発、アウトドアギア収集
              </li>
            </ul>
            <p>
            ...
            <h3>1. 実機所有・実体験のみレビューする</h3>
            <p>
              掲載しているギアは、原則として運営者が実際に所有・使用したものに
              限定しています。スペック紹介で済ませず、購入から廃棄までの
              ライフサイクル全体での使用感をお届けします。
            </p>

            <h3>2. 安全性を医学的観点から評価する</h3>
            <p>
